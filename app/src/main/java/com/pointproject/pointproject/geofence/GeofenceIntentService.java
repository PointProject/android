...
public class GeofenceIntentService extends IntentService {
     ...
     *               Services (inside a PendingIntent)
     */
    @Override
    protected void onHandleIntent(Intent intent) {
        ...
        if (geofencingEvent.hasError()) {
            String errorMessage = "GeofencingEvent error code: " + geofencingEvent.getErrorCode();
     ...
     * @param triggeringGeofences   The geofences triggered
